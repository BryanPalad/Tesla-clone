...
import './sectionthirteen.scss';
import { Fade } from 'react-reveal';
import RemoveRedEyeOutlinedIcon from '@mui/icons-material/RemoveRedEyeOutlined';

function Sectionthirteen() {
  return (
    <div className='model-x-section13'>
        <div className="section-thirteen-img">
        ...
        <div className='lower-desc'>
            <div className='lower-container'>
                <div className='lower-items'>
                    ...
                    <p>Autopilot enables your car to steer, accelerate and brake automatically within its lane under your active supervision, 
                    assisting with the most burdensome parts of driving. With over-the-air software updates, the latest enhancements are available instantly.</p>
                    </div>
                    </Fade>
                </div>
                <Fade bottom>
